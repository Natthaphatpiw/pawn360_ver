...
export async function POST(request: NextRequest) {
  try {
    ...
    const shopRequestData = {
      ...
      message: message || `ลูกค้าขอไถ่ถอนสัญญา ${contract.contractNumber}`,
    ...
    return NextResponse.json({
      success: true,
      message: 'คำขอไถ่ถอนถูกส่งไปยังร้านค้าเรียบร้อยแล้ว',
    ...
    console.error('Customer redemption request error:', error);
    return NextResponse.json(
